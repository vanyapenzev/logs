<script>
    let viewNavBar = false;

    const OnViewNavBar = () => {      
        viewNavBar = !viewNavBar;  
        document.body.classList[viewNavBar ? 'add' : 'remove']('sidebar-hidden');
    }
</script>
    ...
    <nav class="navbar navbar-expand-lg d-flex justify-content-between">
      <div class="" id="navbarNav">
        <ul class="navbar-nav" id="leftNav">
          <li class="nav-item">
            <a class="nav-link" on:click={OnViewNavBar} id="sidebar-toggle" href="##"><i data-feather="arrow-left"></i></a>
          </li>
          <li class="nav-item">
