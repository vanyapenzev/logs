<script>
    ...
    const CreateOrders = (node) => {
        ...
        var chart2 = new ApexCharts(node, options2);
        chart2.render();
    }
</script>
    ...
    <div class="row">
      <div class="col-md-6 col-xl-3">
        <div class="card stat-widget">
            <div class="card-body">
                <h5 class="card-title">Новые игроки</h5>
                  <h2>132</h2>
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card stat-widget">
            <div class="card-body">
                <h5 class="card-title">Донатов</h5>
                  <h2>287</h2>
                  <p>С начала месяца</p>
                  <div class="progress">
      ...
      <div class="col-md-6 col-xl-3">
        <div class="card stat-widget">
            <div class="card-body">
                <h5 class="card-title">Профит за месяц</h5>
                  <h2>600000 ₽</h2>
                  <p>С начала месяца</p>
                  <div class="progress">
